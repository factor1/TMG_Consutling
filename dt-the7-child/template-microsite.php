...
get_header(); ?>
		...
		<?php if (true == get_field( 'factor1_homepage' )) : ?>
				<?php $hero_bg = get_field('hero_image') ? sprintf('style="background: url(%s) center center/cover no-repeat"', get_field('hero_image')['sizes']['large']) : ''; ?>
				<div class="f1-home">
					<div class="f1-hero" <?php echo $hero_bg; ?>>
					...
					<div class="f1-body">
						<div class="f1-content">
							<?php $body_img = get_field('body_image') ? sprintf('style="background: url(%s) center center/cover no-repeat"', get_field('body_image')['sizes']['large']) : ''; ?>
						...
						<?php if ( have_rows( 'features' ) ) : ?>
							<div class="f1-features">
									<?php while ( have_rows( 'features' ) ) : the_row(); ?>
										...
										<div class="f1-feature" <?php echo $feature_img; ?>>
